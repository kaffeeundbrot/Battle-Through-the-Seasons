// Four Seasons Animated Scene with Parabolic Sun and Clouds
#include <GL/glut.h>
#include <GL/glu.h>
#include <cmath>
#include <vector>
...
void drawSun(float x) {
    ...
    float h = WINDOW_WIDTH/2.0f; // horizontal midpoint
    float k = 520;               // peak height
    float a = -0.0015f;          // curvature
    float y = a*(x - h)*(x - h) + k;
...
int main(int argc,char**argv){
    ...
    glutCreateWindow("Four Seasons Animated Scene");
    initGL();
